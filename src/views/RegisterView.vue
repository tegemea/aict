...
import { useEmploymentStatusStore } from '../stores/employmentStatuses';
            ...
            <VCol cols="12" md="7">
                <VForm v-model="valid" ref="registerForm">
                    <VRow>
                        ...
                        <VCol cols="12" sm="6">
                            <VTextField variant="outlined" :rules="[required('Last name'), minLength('Last name', 3), maxLength('Last name', 30)]" rounded-lg v-model="user.last_name" counter="30" label="Last name" required>
                            </VTextField>
                        </VCol>
                        <VCol cols="12" sm="6">
                            <VTextField variant="outlined" :rules="[required('Email Address'), isEmailValid]" rounded-lg type="email" v-model="user.email" label="Email address" required />
                        </VCol>
                        <VCol cols="12" sm="6">
                            <VTextField variant="outlined" :rules="[required('Phone number')]" rounded-lg type="tel" v-model="user.phone" label="Phone number" required hint="We may use to call / SMS / WhatsApp" />
                        </VCol>
                        <VCol cols="12">
                            <VTextField variant="outlined" rounded-lg type="text" v-model="user.company_name" label="Company name (optional)" hint="Enter Company name if you own or working for any, comma separated if more than one" />
                        </VCol>
                        <VCol cols="12" sm="6">
                        ...
                        <VCol cols="12">
                            <VCheckbox v-model="user.professional" color="red" label="I'm a Professional ICT personnel (Please uncheck this if you are just a stakeholder)" />
                        </VCol>
                        <VSlideYTransition>
                            <VCol v-if="user.professional" cols="12">
                                <VSelect v-model="user.skills" label="Select Your Major Skill/s (scroll for more)" :rules="[required('Professional Skill/s')]" :items="skills" item-title="name" item-value="id" variant="outlined" multiple chips clearable />
                            </VCol>
                        </VSlideYTransition>
                                        ...
                                        <VRow class="d-flex align-center">
                                            ...
                                            <VSlideYTransition mode="out-in">
                                                ...
                                                <VCol v-else cols="11" class="" style="padding: 13px 12px;">
                                                    <VTextField :disabled="!otherSkills" variant="outlined" :rules="[required('Other skill/s not listed above')]" rounded-lg type="text" v-model="user.otherSkills" label="ex. Other Skill 1, Other Skill 2, etc..." hint="Enter other skill/s not listed above ( comma separated if more than one )" persistent-hint clearable />
                                                </VCol>
                                            </VSlideYTransition>
                                        </VRow>
                                    </VCard>
                        ...
                        <VCol cols="12" class="mt-5">
                            <VBtn @click.prevent="registerUser" :disabled="!valid" size="x-large" class="text-white bg-success me-3">
